...
<form name="addForm" action="adduser" method="post" onsubmit="return validateUserForm()">
		...
		<input type="text" name="password" id="ups" placeholder="Enter User Password">
		
		<label for="ucp">Confirm Password :</label>
		<input type="text" name="role" id="ucp" placeholder="Enter Confirm Password">
